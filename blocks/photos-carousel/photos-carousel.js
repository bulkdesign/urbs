(() => {
    ...
    if (!document.querySelectorAll('.photos-carousel-list').length) return false;
    ...
    document.querySelectorAll('.photos-carousel-list').forEach((carousel) => {
        const default_carousel_settings = {
            spaceBetween: 30,
            slidesPerView: 'auto',
            simulateTouch: false,
            navigation: {
                nextEl: carousel.closest('.photos-carousel').querySelector('.photos-carousel-navigation-next'),
                prevEl: carousel.closest('.photos-carousel').querySelector('.photos-carousel-navigation-prev')
            },  
            pagination: {
                el: carousel.closest('.photos-carousel').querySelector('.photos-carousel-pagination'),
                type: 'bullets',
            },
            on: {
                beforeInit: (swiper) => {
