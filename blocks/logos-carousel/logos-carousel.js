(() => {
    ...
    document.querySelectorAll('.logos-carousel-list').forEach((carousel) => {
        const default_carousel_settings = {
            ...
            simulateTouch: false,
            navigation: {
                nextEl: carousel.closest('.logos-carousel').querySelector('.logos-carousel-navigation-next'),
                prevEl: carousel.closest('.logos-carousel').querySelector('.logos-carousel-navigation-prev')
            },  
            pagination: {
                el: carousel.closest('.logos-carousel').querySelector('.logos-carousel-pagination'),
                type: 'bullets',
            },
            on: {
                beforeInit: (swiper) => {
