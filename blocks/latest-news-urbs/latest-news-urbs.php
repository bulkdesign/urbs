...
<section <?php theme_block_attributes( $block, 'latest-news-urbs' ); ?>>
    ...
    <div class="news">
        ...
        <?php if ( $the_query->have_posts() ) : ?>
            <div class="latest-news-urbs-wrapper">
                <div class="swiper news-carousel" data-loop="<?php the_field( 'enable_carousel_loop' ); ?>" data-autoplay="<?php the_field( 'enable_carousel_autoplay' ); ?>" data-animation>
                    ...
                    <?php if ( get_field( 'enable_carousel_navigation' ) ) : ?>
                        <div class="latest-news-urbs-navigation" data-animation>
                            <button class="latest-news-urbs-navigation-next" aria-label="<?php esc_attr_e( 'Next Logo', 'bulk' ); ?>" title="<?php esc_attr_e( 'Next Logo', 'bulk' ); ?>">
                ...
                <?php if ( get_field( 'enable_carousel_pagination' ) ) : ?>
                    <div class="latest-news-urbs-pagination" role="presentation" data-animation></div>
                <?php endif; ?>
            </div>
        <?php endif; ?>
