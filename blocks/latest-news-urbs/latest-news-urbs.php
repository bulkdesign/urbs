...
<section <?php theme_block_attributes( $block, 'latest-news-urbs' ); ?>>
    ...
    <div class="news">
        ...
        <?php if ( $the_query->have_posts() ) : ?>
            <div class="latest-news-urbs-list-wrapper">
                ...
                <?php if ( get_field( 'enable_carousel_navigation' ) ) : ?>
                    <div class="latest-news-urbs-navigation" data-animation>
                        <button class="latest-news-urbs-navigation-prev" aria-label="<?php esc_attr_e( 'Previous Logo', 'bulk' ); ?>" title="<?php esc_attr_e( 'Previous Logo', 'bulk' ); ?>">
