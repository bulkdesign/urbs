    ...
    horarioWrapper.forEach((horario) => {
        ...
        const listaLinhas = async () => {
            ...
            try {
                ...
                const cacheUrlLinhas = '/portal/wp-content/urbs_data/urbs_horarios/linhas_ativas.json';
        ...
        linhasSelect.addEventListener('change', async (e) => {
            ...
            try {
                const cacheUrl = `/portal/wp-content/urbs_data/urbs_horarios/linha_${codigoLinha}.json`;
